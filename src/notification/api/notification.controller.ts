...
export class NotificationController {
    ...
    async getClientById(
        ...
        try {
            const result: Result<AppNotification, GetNotificationByIdDto> = await this.notificationApplicationService.getById(id);
            if (result.isSuccess()) {
    ...
    async register(
        ...
        try{
            const result: Result<AppNotification, RegisterNotificationResponseDto> = await this.notificationApplicationService.register(
